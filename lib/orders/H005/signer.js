...
const digest = (doc) => {
	...
	const fixedContent = contentToDigest.replace(/xmlns="urn:org:ebics:H005"/g, 'xmlns="urn:org:ebics:H005" xmlns:ds="http://www.w3.org/2000/09/xmldsig#"');
...
const sign = (doc, key) => {
	...
	if (nodeSignatureValue) {
		...
		const contentToSign = (new C14n().process(select('//ds:SignedInfo', doc)[0])).replace('xmlns:ds="http://www.w3.org/2000/09/xmldsig#"', 'xmlns="urn:org:ebics:H005" xmlns:ds="http://www.w3.org/2000/09/xmldsig#"');
